...
---
## Synopsis
This projects describes the steps necessary to [web scrape](http://en.wikipedia.org/wiki/Data_scraping) data from the [Theradoc Infeciton Control Applicaiton Software](http://www.theradoc.com). Specifically, we're aiming to automate the extraction, transformation and loading of TheraDoc version 4.5.5 reports and get the data into a MS SQL Server database. The end goal is to use and illustrate this data in other SSRS reports. 
